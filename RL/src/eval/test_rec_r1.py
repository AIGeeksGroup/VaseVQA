...
# --- Set REPO_HOME ---
# Recommended method: get the directory where the script file is located
...
# --- Build other paths using REPO_HOME ---
RUN_NAME = "Qwen2.5-VL-3B-Instruct-rec"

# Use os.path.join to build paths, which is safer than manual string concatenation
MODEL_PATH = os.path.join(REPO_HOME, 'checkpoints', 'rl', RUN_NAME, f'checkpoint-{steps}')

# For ../ (parent directory) cases
...
# --- Other parameters ---
# OUTPUT_PATH doesn't need REPO_HOME since it's a relative path
