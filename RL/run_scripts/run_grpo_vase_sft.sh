...
model_path="${REPO_HOME}/../LLaMA-Factory/saves/qwen2_5vl-3b/full/vase_single_sft_V2/checkpoint-501"  # Model path after SFT training
...
export EXP_NAME="Vase-RL-SFT-v3"
TASK_TYPE="vase"
...
export WANDB_PROJECT="vase-rl-and-sft-v2"
