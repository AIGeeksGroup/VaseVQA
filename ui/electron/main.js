...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    icon: path.join(__dirname, '../public/imgs/vase.png')
  });

  // 设置窗口标题
  mainWindow.setTitle(`Vase Dataset v${getAppVersion()}`);
        ...
        },
        {
          ...
          click: () => {
            dialog.showMessageBox(mainWindow, {
              title: '关于 Vase Dataset',
              message: `Vase Dataset v${getAppVersion()}`,
...
async function startNextServer() {
  console.log(`Vase Dataset 客户端启动中，当前版本: ${getAppVersion()}`);
